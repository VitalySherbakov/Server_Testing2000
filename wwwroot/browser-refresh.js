setTimeout(async function () {
  ...
  const webSocketUrls = 'wss://localhost:44340/WebSiteTest/,ws://localhost:55411/WebSiteTest/'.split(',');
  const sharedSecret = await getSecret('');
  let connection;
